...
class FeatureExtractor(Backbone):
    ...
    def __init__(self):
        ...
        self.conv3_dida = DIDAModule(3, 64, 128, m=16, padding=1, stride=1)
        self.bn3_dida = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        ...
        x2 = F.relu(self.bn3_dida(self.conv3_dida(x)))
        x = x1 + x2
...
def cnn_digit5_m3sda_dida(**kwargs):
    """
